package vip.xubin.admin.service.impl;
...
import vip.xubin.admin.service.ContentService;
import vip.xubin.mapper.TbCategoryMapper;
import vip.xubin.mapper.TbCategorySecondaryMapper;
...
@Service
@Transactional
@com.alibaba.dubbo.config.annotation.Service(interfaceClass = vip.xubin.admin.service.ContentService.class, protocol = {"dubbo"}, retries = 0)
