...
import vip.xubin.search.mapper.SearchMapper;
import vip.xubin.search.service.SearchService;
...
@Service
@com.alibaba.dubbo.config.annotation.Service(interfaceClass = SearchService.class, protocol = {"dubbo", "rest"}, retries = 0)
