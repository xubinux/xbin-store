...
<head>
    ...
    <%--<script src="//local.adguard.com/adguard-ajax-api/injections/content-script.js?sb=1&ts=1487649806.572475&js=1&domain=cart.jd.com&css=1&generic=1"--%>
            <%--type="text/javascript" crossorigin="anonymous"></script>--%>
    <%--<script src="//local.adguard.com/adguard-ajax-api/injections/userscripts/Adguard Assistant?ts=1487649974.511372"--%>
            <%--type="text/javascript" crossorigin="anonymous"></script>--%>
...
<noscript>
    <iframe src="//www.googletagmanager.com/ns.html?id=GTM-T947SH" height="0" width="0"
...
<div class="w">
    <div id="logo-2014">
        <a href="//www.jd.com/" class="logo">XBin</a>
    </div>
    <div id="search-2014">
    ...
    <div class="success-wrap">
        <div class="w" id="result">
            <c:choose>
                    ...
                    <div class="m succeed-box">
                        <div class="mc success-cont">
                            <div class="success-lcol">
                                ...
                                <div class="p-item">
                                    <div class="p-img"><a href="http://localhost:8103/${cartInfo.id}.html"
                                                          target="_blank"><img
                                            src="${cartInfo.imageUrl}"
                                            clstag="pageclick|keycount|201601152|11" height="54" width="54"></a></div>
                                    <div class="p-info">
                                        <div class="p-name"><a href="http://localhost:8103/${cartInfo.id}.html"
                                                               target="_blank"
                                                               clstag="pageclick|keycount|201601152|2"
                                                               title="${cartInfo.name}">${cartInfo.name}</a></div>
                                        <div class="p-extra"><span class="txt"
                                                                   title="${cartInfo.colour}">颜色：${cartInfo.colour}</span><span
                                                class="txt"
                                                title="${cartInfo.size}">尺码：${cartInfo.size}</span><span
                                                class="txt">/  数量：${cartInfo.num}</span></div>
                                    </div>
                                    <div class="clr"></div>
                                </div>
                            </div>
                ...
                <c:otherwise>
                    <div class="m succeed-box">
                        <div class="mc error-cont">
                            <div class="error-lcol">
                                <div class="error-top"><b class="succ-icon"></b>
                                    <h3 class="ftx-02">商品加入购物车失败！</h3></div>
                            </div>
                            <div class="error-btns success-btns-new">
                                <div class="error-ad"><a href="#none"></a></div>
                                <div class="clr"></div>
                                <div><a class="btn-tobback" href="http://localhost:8103/${cartInfo.id}.html"
                                        target="_blank" clstag="pageclick|keycount|201601152|3">查看商品详情</a><a
                                        class="btn-addtocart" href="http://localhost:8107/cart.html"
                                        id="errorGotoShoppingCart" clstag="pageclick|keycount|201601152|4"><b></b>去购物车结算</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="./js/config.js?v=201610261557"></script>
<script type="text/javascript" src="./js/initCartNew.js?v=201610261557"></script>
<script type="text/javascript">
    seajs.use([
